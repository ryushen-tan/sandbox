...
export function Lobby({ onCreateRoom, onJoinRoom, error }: LobbyProps) {
  ...
  return (
    <main className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden bg-[#080806] px-6 text-stone-50">
      {/* Ambient glow */}
      ...
      <div className="relative flex w-full max-w-sm flex-col items-center gap-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-stone-500">
            Watch reels. Keep a straight face.<br />
            Smile and your health drains. Last one standing wins.
          </p>
        </div>
        ...
        <div className="flex w-full flex-col gap-3">
          <button
            ...
            disabled={!connected}
            className="w-full rounded-xl bg-stone-50 px-5 py-3 text-sm font-semibold text-stone-900 transition-opacity hover:opacity-90 active:opacity-75 disabled:cursor-not-allowed disabled:opacity-40"
          >
        ...
        <div className="flex items-center gap-2">
          <span className={`h-1.5 w-1.5 rounded-full ${connected ? 'bg-emerald-400' : 'bg-stone-600 animate-pulse'}`} />
